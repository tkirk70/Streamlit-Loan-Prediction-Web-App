...
if btn_predict:
    ...
    loans = st.cache(pd.read_csv)("https://github.com/tkirk70/Streamlit-Loan-Prediction-Web-App/blob/fdfac9250d37144b7b08223ec3c6b551c38a199b/archive%20(2).zip/mycsvfile.csv")
